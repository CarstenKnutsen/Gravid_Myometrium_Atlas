...
fns = ['TNL_GC_v_PNL_ND_pseudobulk_comparisons',
       'TNL_GC_v_TL_ND_pseudobulk_comparisons',
       'TNL_GC_v_TNL_BC_pseudobulk_comparisons',
       ]
deg_fol = '/home/carsten/alvira_bioinformatics/uterus/data/figures/deg/pseudobulk/'
output_fol = '/home/carsten/alvira_bioinformatics/uterus/data/figures/deg/pathway'
...
if __name__ =='__main__':
    # for fn in fns:
    #     deg_fn = f'{deg_fol}/{fn}.xlsx'
    #     output_fn_fol = f'{output_fol}/{fn}'
    #     os.makedirs(output_fn_fol, exist_ok=True)
    #     deg_to_metascape(deg_fn, output_fn_fol, threshold=True,fc_name='log2FoldChange', fc_threshold=0.25, pvalue_name='pvalue',pvalue_threshold=0.05)
    for fn in fns:
        deg_fn = f'{deg_fol}/{fn}.xlsx'
        output_fn_fol = f'{output_fol}/{fn}_strict'
        os.makedirs(output_fn_fol, exist_ok=True)
        deg_to_metascape(deg_fn, output_fn_fol, threshold=True,fc_name='log2FoldChange', fc_threshold=1, pvalue_name='padj',pvalue_threshold=0.05)
